                ...
                double* bias_seq_4_1, double* bias_seq_4_2, double* bias_seq_4_3, double* bias_seq_4_4, double* bias_seq_4_5, double* bias_seq_4_6, double* bias_seq_4_7, double* bias_seq_4_8,double* bias_seq_4_9)
{
    ...
    Conv2Plus1D(X_data, X_num, X_data, X_num, 144, 
                ...
                4.517441987991333008e-02, 9.410868585109710693e-02, 3.386811539530754089e-02, 68, 72, 67,
    ...
    Conv2Plus1D(X_data, X_num, X2_data, X2_num, 230, 
                ...
                5.917721241712570190e-02, 1.296460330486297607e-01, 3.311596438288688660e-02, 53, 76, 64,
    ...
    Conv2Plus1D(X2_data, X2_num, X2_data, X2_num, 288, 
                ...
                5.221061781048774719e-02, 1.044261455535888672e-01, 2.876071259379386902e-02, 61, 64, 63,
    ...
    Conv2Plus1D(X2_data, X2_num, X3_data, X3_num, 460, 
                ...
                6.300298124551773071e-02,  1.026936098933219910e-01, 3.513325005769729614e-02, 70, 66, 64,
    ...
    Conv2Plus1D(X3_data, X3_num, X3_data, X3_num, 576, 
                ...
                4.242179170250892639e-02, 9.108851104974746704e-02, 2.204562351107597351e-02, 52, 60, 64,
    ...
    Conv2Plus1D(X3_data, X3_num, X4_data, X4_num, 921, 
                ...
                3.744378685951232910e-02, 7.933901995420455933e-02, 4.174583032727241516e-02, 78, 64, 60,
    ...
    Conv2Plus1D(X4_data, X4_num, X4_data, X4_num, 1152, 
                ...
                8.961183577775955200e-02,5.083529949188232422e-01, 3.209327906370162964e-02, 57, 59, 57, 
