                ...
                dtype* X_tmp_data, dtype* X2_data, dtype* X2_tmp_data, dtype* X_mid_data, dtype* X_batch_data)
{
    ...
    BatchNorm3d(X_data, X_batch_data, X3_num, Mu_seq3_0_conv1_1, Var_seq3_0_conv1_1, Gamma_seq3_0_conv1_1, Bias_seq3_0_conv1_1, 3.513325005769729614e-02, 64, 3.827788308262825012e-02, 59);
    ...
    BatchNorm3d(X_data, X_batch_data, X3_num, Mu_seq3_0_conv2_1, Var_seq3_0_conv2_1, Gamma_seq3_0_conv2_1, Bias_seq3_0_conv2_1, 3.355694189667701721e-02, 57, 3.775262087583541870e-02, 63);

    Conv3d(X2_tmp_data, X2_num, X_tmp_data, X3_num, Kernel_3_5_data, Kernel_num, Kernel_seq3_0_downsample_0_scale, stride, padding, 7.469348609447479248e-02, 58, 3.776641562581062317e-02, 72);
    BatchNorm3d(X_tmp_data, X_tmp_data, X3_num, Mu_seq3_0_downsample_1, Var_seq3_0_downsample_1, Gamma_seq3_0_downsample_1, Bias_seq3_0_downsample_1, 3.776641562581062317e-02, 72, 4.242179170250892639e-02, 52);
    // layer3.0
    ...
    BatchNorm3d(X_data, X_batch_data, X3_num, Mu_seq3_1_conv1_1, Var_seq3_1_conv1_1, Gamma_seq3_1_conv1_1, Bias_seq3_1_conv1_1, 2.204562351107597351e-02, 64, 2.682571485638618469e-02, 55);
    ...
    BatchNorm3d(X_data, X_batch_data, X3_num, Mu_seq3_1_conv2_1, Var_seq3_1_conv2_1, Gamma_seq3_1_conv2_1, Bias_seq3_1_conv2_1, 3.477662429213523865e-02, 82, 3.744378685951232910e-02, 78);
    // layer3.1
    ...
    Conv3d(X_tmp_data, X3_num, X2_tmp_data, X4_num, Kernel_4_5_data, Kernel_num, Kernel_seq4_0_downsample_0_scale, stride, padding, 4.908789321780204773e-02, 58, 2.351688779890537262e-02, 60);
    BatchNorm3d(X2_tmp_data, X2_tmp_data, X4_num, Mu_seq4_0_downsample_1, Var_seq4_0_downsample_1, Gamma_seq4_0_downsample_1, Bias_seq4_0_downsample_1,2.351688779890537262e-02, 60, 5.310279503464698792e-02, 59);
    // layer4.0
    ...
    BatchNorm3d(X2_data, X_batch_data, X4_num, Mu_seq4_1_conv1_1, Var_seq4_1_conv1_1, Gamma_seq4_1_conv1_1, Bias_seq4_1_conv1_1, 3.209327906370162964e-02, 57, 2.595668099820613861e-02, 68);
    ...
    BatchNorm3d(X2_data, X_batch_data, X4_num, Mu_seq4_1_conv2_1, Var_seq4_1_conv2_1, Gamma_seq4_1_conv2_1, Bias_seq4_1_conv2_1, 2.505685016512870789e-02, 59, 1.026933342218399048e-01, 42);
    // layer4.1
