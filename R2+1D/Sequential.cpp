                ...
                )
{
    ...
    Conv2Plus1D(X_data, X_num, X_mid_data, X2_batch_data, X2_data, X2_num, 230, 
    ...
    Conv2Plus1D(X2_data, X2_num, X_mid_data, X2_batch_data, X2_data, X2_num, 230, 
    ...
    Conv2Plus1D(X2_data, X2_num, X_mid_data, X2_batch_data, X2_data, X2_num, 288, 
    ...
    for(int_t i = 0; i< 802816; i++)
        X2_tmp_data[i] = X2_data[i];
    Conv2Plus1D(X2_data, X2_num, X_mid_data, X3_batch_data, X3_data, X3_num, 460, 
    ...
    Conv2Plus1D(X3_data, X3_num, X_mid_data, X3_batch_data, X3_data, X3_num, 460, 
    ...
    Conv2Plus1D(X3_data, X3_num, X_mid_data, X3_batch_data, X3_data, X3_num, 576, 
    ...
    for(int_t i = 0; i< 200704; i++)
        X3_tmp_data[i] = X3_data[i];
    Conv2Plus1D(X3_data, X3_num, X_mid_data, X4_batch_data, X4_data, X4_num, 921, 
    ...
    Conv2Plus1D(X4_data, X4_num, X_mid_data, X4_batch_data, X4_data, X4_num, 921, 
    ...
    Conv2Plus1D(X4_data, X4_num, X_mid_data, X4_batch_data, X4_data, X4_num, 1152, 
