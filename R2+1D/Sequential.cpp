                ...
                double* bias_seq_4_1, double* bias_seq_4_2, double* bias_seq_4_3, double* bias_seq_4_4, double* bias_seq_4_5, double* bias_seq_4_6, double* bias_seq_4_7, double* bias_seq_4_8,double* bias_seq_4_9)
{
    ...
    Conv2Plus1D(X_data, X_num, X_data, X_num, 144, 
                ...
                X_scale, X_zeropoint, 8.706942945718765259e-02, 4.961582273244857788e-02, 64, 71,
    ...
    Conv2Plus1D(X_data, X_num, X_data, X_num, 144, 
                ...
                5.436319485306739807e-02, 74, 6.804036349058151245e-02, 3.850702568888664246e-02, 60, 66,
    ...
    ReLU(X_data, X_num, 68);

    for(int_t i = 0; i < 3211264; i++)
        X_tmp_data[i] = X_data[i];
    Conv2Plus1D(X_data, X_num, X_data, X_num, 144, 
                Kernel_1_5_data, Kernel_1_6_data, Kernel_1_5_data_scale, Kernel_1_6_data_scale, 1, 1, 
                4.517441987991333008e-02, 68, 9.410868585109710693e-02, 3.386811539530754089e-02, 72, 67,
    ...
    Conv2Plus1D(X_data, X_num, X_data, X_num, 144, 
                ...
                4.148417711257934570e-02, 70, 3.422784805297851562e-02, 2.731916867196559906e-02, 68, 71,
    ...
    Conv2Plus1D(X_data, X_num, X2_data, X2_num, 230, 
                ...
                5.917721241712570190e-02, 53, 1.296460330486297607e-01, 3.311596438288688660e-02, 76, 64,
    ...
    Conv2Plus1D(X2_data, X2_num, X2_data, X2_num, 230, 
                ...
                3.730613738298416138e-02, 52, 6.581791490316390991e-02, 3.792280331254005432e-02, 68, 70,
    ...
    Conv3d(X_tmp_data, X_num, X2_tmp_data, X2_num, Kernel_2_5_data, Kernel_num, Kernel_2_5_data_scale, stride, padding, 5.917721241712570190e-02, 53, 5.711162462830543518e-02, 68);
    ...
    Conv2Plus1D(X2_data, X2_num, X2_data, X2_num, 288, 
                ...
                5.221061781048774719e-02, 61, 1.044261455535888672e-01, 2.876071259379386902e-02, 64, 63,
    ...
    Conv2Plus1D(X2_data, X2_num, X2_data, X2_num, 288, 
                ...
                4.108780622482299805e-02, 69, 4.689884185791015625e-02, 2.438377402722835541e-02, 55, 66,
    ...
    Conv2Plus1D(X2_data, X2_num, X3_data, X3_num, 460, 
                ...
                6.300298124551773071e-02, 70, 1.026936098933219910e-01, 3.513325005769729614e-02, 66, 64,
    ...
    Conv2Plus1D(X3_data, X3_num, X3_data, X3_num, 460, 
                ...
                3.827788308262825012e-02, 59, 7.229902595281600952e-02, 3.355694189667701721e-02, 74, 57,
    ...
    Conv3d(X2_tmp_data, X2_num, X3_tmp_data, X3_num, Kernel_3_5_data, Kernel_num, Kernel_3_5_data_scale, stride, padding, 6.300298124551773071e-02, 70, 3.776641562581062317e-02, 72);
    ...
    Conv2Plus1D(X3_data, X3_num, X3_data, X3_num, 576, 
                ...
                4.242179170250892639e-02, 52, 9.108851104974746704e-02, 2.204562351107597351e-02, 60, 64,
    ...
    Conv2Plus1D(X3_data, X3_num, X3_data, X3_num, 576, 
                ...
                2.682571485638618469e-02, 55, 4.488958418369293213e-02, 3.477662429213523865e-02, 58, 82,
    ...
    Conv2Plus1D(X3_data, X3_num, X4_data, X4_num, 921, 
                ...
                3.744378685951232910e-02, 78, 7.933901995420455933e-02, 4.174583032727241516e-02, 64, 60,
    ...
    Conv3d(X3_tmp_data, X3_num, X4_tmp_data, X4_num, Kernel_4_5_data, Kernel_num, Kernel_4_5_data_scale, stride, padding, 3.744378685951232910e-02, 78, 2.351688779890537262e-02, 60);
    ...
    Conv2Plus1D(X4_data, X4_num, X4_data, X4_num, 1152, 
                ...
                8.961183577775955200e-02, 57, Mu_seq_4_6, Var_seq_4_6, Gamma_seq_4_6, bias_seq_4_6, 2.375184185802936554e-02, 66); // 1152 = (512 * 512 * 3 * 3) / (512 * 3 + 512)
    ...
    Conv2Plus1D(X4_data, X4_num, X4_data, X4_num, 1152, 
                ...
                2.595668099820613861e-02, 68, 8.170315623283386230e-02, 2.505685016512870789e-02, 67, 59,
