                ...
                dtype* X_tmp_data, dtype* X2_data, dtype* X2_tmp_data, dtype* X_mid_data, dtype* X_batch_data)
{
    ...
    BatchNorm3d(X_data, X_batch_data ,X_num, Mu_seq_1_2, Var_seq_1_2, Gamma_seq_1_2, bias_seq_1_2,4.961582273244857788e-02 ,71, 5.436319485306739807e-02, 74);
    ...
    BatchNorm3d(X_data, X_batch_data,X_num, Mu_seq_1_4, Var_seq_1_4, Gamma_seq_1_4, bias_seq_1_4, 3.850702568888664246e-02, 66 ,4.517441987991333008e-02, 68);
    // layer1.0
    ...
    BatchNorm3d(X_data, X_batch_data,X_num, Mu_seq_1_6, Var_seq_1_6, Gamma_seq_1_6, bias_seq_1_6,3.386811539530754089e-02,67,4.148417711257934570e-02, 70);
    ...
    BatchNorm3d(X_data, X_batch_data, X_num, Mu_seq_1_8, Var_seq_1_8, Gamma_seq_1_8, bias_seq_1_8,2.731916867196559906e-02, 71, 5.917721241712570190e-02, 53);
    // layer1.1
    ...
    BatchNorm3d(X2_data, X_batch_data,X2_num, Mu_seq_2_2, Var_seq_2_2, Gamma_seq_2_2, bias_seq_2_2, 3.311596438288688660e-02, 64,3.730613738298416138e-02, 52);
    ...
    BatchNorm3d(X2_data, X_batch_data, X2_num, Mu_seq_2_4, Var_seq_2_4, Gamma_seq_2_4, bias_seq_2_4, 3.792280331254005432e-02, 70, 5.221061781048774719e-02, 61);
    ...
    BatchNorm3d(X2_tmp_data, X2_tmp_data, X2_num, Mu_seq_2_5, Var_seq_2_5, Gamma_seq_2_5, bias_seq_2_5, 5.711162462830543518e-02, 68, 5.571814253926277161e-02, 53);
    ...
    Conv2Plus1D(X2_data, X2_num, X_mid_data, X_batch_data, X2_data, X2_num, 288, 
    ...
    BatchNorm3d(X2_data, X_batch_data, X2_num, Mu_seq_2_7, Var_seq_2_7, Gamma_seq_2_7, bias_seq_2_7,  2.876071259379386902e-02, 63, 4.108780622482299805e-02, 69);
    ...
    BatchNorm3d(X2_data, X_batch_data, X2_num, Mu_seq_2_9, Var_seq_2_9, Gamma_seq_2_9, bias_seq_2_9, 2.438377402722835541e-02, 66, 6.300298124551773071e-02, 70);
    // layer2.1
    ...
    for(int_t i = 0; i< 802816; i++)
        X2_tmp_data[i] = X2_data[i];
    Conv2Plus1D(X2_data, X2_num, X_mid_data, X_batch_data, X_data, X3_num, 460, 
    ...
    BatchNorm3d(X_data, X_batch_data, X3_num, Mu_seq_3_2, Var_seq_3_2, Gamma_seq_3_2, bias_seq_3_2, 3.513325005769729614e-02, 64, 3.827788308262825012e-02, 59);
    ReLU(X_batch_data, X_data, X3_num, 59);
    Conv2Plus1D(X_data, X3_num, X_mid_data, X_batch_data, X_data, X3_num, 460, 
    ...
    BatchNorm3d(X_data, X_batch_data, X3_num, Mu_seq_3_4, Var_seq_3_4, Gamma_seq_3_4, bias_seq_3_4, 3.355694189667701721e-02, 57, 3.775262087583541870e-02, 63);

    Conv3d(X2_tmp_data, X2_num, X_tmp_data, X3_num, Kernel_3_5_data, Kernel_num, Kernel_3_5_data_scale, stride, padding, 7.469348609447479248e-02, 58, 3.776641562581062317e-02, 72);
    BatchNorm3d(X_tmp_data, X_tmp_data, X3_num, Mu_seq_3_5, Var_seq_3_5, Gamma_seq_3_5, bias_seq_3_5, 3.776641562581062317e-02, 72, 4.242179170250892639e-02, 52);
    // layer3.0
    Residual(X_batch_data, X_tmp_data, X3_num, 3.775262087583541870e-02, 4.242179170250892639e-02, 4.819526150822639465e-02, 63, 52, 56);
    ReLU(X_batch_data, X_data, X3_num, 56);
    
    for(int_t i = 0; i< 200704; i++)
        X_tmp_data[i] = X_data[i];
    Conv2Plus1D(X_data, X3_num, X_mid_data, X_batch_data, X_data, X3_num, 576, 
    ...
    BatchNorm3d(X_data, X_batch_data, X3_num, Mu_seq_3_7, Var_seq_3_7, Gamma_seq_3_7, bias_seq_3_7, 2.204562351107597351e-02, 64, 2.682571485638618469e-02, 55);
    ReLU(X_batch_data, X_data, X3_num, 55);
    Conv2Plus1D(X_data, X3_num, X_mid_data, X_batch_data, X_data, X3_num, 576, 
    ...
    BatchNorm3d(X_data, X_batch_data, X3_num, Mu_seq_3_9, Var_seq_3_9, Gamma_seq_3_9, bias_seq_3_9, 3.477662429213523865e-02, 82, 3.744378685951232910e-02, 78);
    // layer3.1
    Residual(X_batch_data, X_tmp_data, X3_num, 3.744378685951232910e-02, 4.819526150822639465e-02, 4.908789321780204773e-02, 78, 56, 58);
    ReLU(X_batch_data, X_data, X3_num, 58);
    ...
    for(int_t i = 0; i< 200704; i++)
        X_tmp_data[i] = X_data[i];
    Conv2Plus1D(X_data, X3_num, X_mid_data, X_batch_data, X2_data, X4_num, 921, 
    ...
    BatchNorm3d(X2_data, X_batch_data, X4_num, Mu_seq_4_2, Var_seq_4_2, Gamma_seq_4_2, bias_seq_4_2, 4.174583032727241516e-02, 60,3.296769410371780396e-02, 49);
    ...
    BatchNorm3d(X2_data, X_batch_data, X4_num,  Mu_seq_4_4, Var_seq_4_4, Gamma_seq_4_4, bias_seq_4_4, 3.702012076973915100e-02,56 ,8.961183577775955200e-02, 57);

    Conv3d(X_tmp_data, X3_num, X2_tmp_data, X4_num, Kernel_4_5_data, Kernel_num, Kernel_4_5_data_scale, stride, padding, 4.908789321780204773e-02, 58, 2.351688779890537262e-02, 60);
    BatchNorm3d(X2_tmp_data, X2_tmp_data, X4_num, Mu_seq_4_5, Var_seq_4_5, Gamma_seq_4_5, bias_seq_4_5,2.351688779890537262e-02, 60, 5.310279503464698792e-02, 59);
    // layer4.0
    Residual(X_batch_data, X2_tmp_data, X4_num, 8.961183577775955200e-02, 5.310279503464698792e-02, 1.033632829785346985e-01, 57, 59, 53);
    ReLU(X_batch_data, X2_data, X4_num, 53);
    
    for(int_t i = 0; i< 50176; i++)
        X2_tmp_data[i] = X2_data[i];
    Conv2Plus1D(X2_data, X4_num, X_mid_data, X_batch_data, X2_data, X4_num, 1152, 
    ...
    BatchNorm3d(X2_data, X_batch_data, X4_num, Mu_seq_4_7, Var_seq_4_7, Gamma_seq_4_7, bias_seq_4_7, 3.209327906370162964e-02, 57, 2.595668099820613861e-02, 68);
    ReLU(X_batch_data, X2_data, X4_num, 68);
    Conv2Plus1D(X2_data, X4_num, X_mid_data, X_batch_data, X2_data, X4_num, 1152, 
    ...
    BatchNorm3d(X2_data, X_batch_data, X4_num, Mu_seq_4_9, Var_seq_4_9, Gamma_seq_4_9, bias_seq_4_9, 2.505685016512870789e-02, 59, 1.026933342218399048e-01, 42);
    // layer4.1
    Residual(X_batch_data, X2_tmp_data, X4_num, 1.026933342218399048e-01, 1.033632829785346985e-01, 1.290386915206909180e-01, 42, 53, 31);
    ReLU(X_batch_data, X2_data, X4_num, 31);
