                ...
                ftype* bias_seq_4_1, ftype* bias_seq_4_2, ftype* bias_seq_4_3, ftype* bias_seq_4_4, ftype* bias_seq_4_5, ftype* bias_seq_4_6, ftype* bias_seq_4_7, ftype* bias_seq_4_8,ftype* bias_seq_4_9)
{
    ...
    for(int_t i = 0; i< 802816; i++)
        X2_tmp_data[i] = X2_data[i];
    Conv2Plus1D(X2_data, X2_num, X_mid_data, X3_data, X3_num, 460, 
    ...
    Conv2Plus1D(X3_data, X3_num, X_mid_data, X3_data, X3_num, 460, 
    ...
    Conv2Plus1D(X3_data, X3_num, X_mid_data, X3_data, X3_num, 576, 
    ...
    for(int_t i = 0; i< 200704; i++)
        X3_tmp_data[i] = X3_data[i];
    Conv2Plus1D(X3_data, X3_num, X_mid_data, X4_data, X4_num, 921, 
    ...
    Conv2Plus1D(X4_data, X4_num, X_mid_data, X4_data, X4_num, 921, 
    ...
    Conv2Plus1D(X4_data, X4_num, X_mid_data, X4_data, X4_num, 1152, 
