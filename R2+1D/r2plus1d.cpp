            ...
            ktype* Kernel_linear, ftype* Kernel_linear_scale)
{
    ...
    #pragma HLS INTERFACE m_axi port=Var_stem_4
    #pragma HLS INTERFACE m_axi port=Bias_stem_1
    #pragma HLS INTERFACE m_axi port=Bias_stem_4
    #pragma HLS INTERFACE m_axi port=Gamma_stem_1
    #pragma HLS INTERFACE m_axi port=Gamma_stem_4
    ...
    #pragma HLS INTERFACE m_axi port=Mu_seq1_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Mu_seq1_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq1_1_conv1_1
    #pragma HLS INTERFACE m_axi port=Mu_seq1_1_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq1_1_conv2_1
    #pragma HLS INTERFACE m_axi port=Mu_seq4_0_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq4_0_conv1_1
    #pragma HLS INTERFACE m_axi port=Mu_seq4_0_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq4_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Mu_seq4_0_downsample_1
    #pragma HLS INTERFACE m_axi port=Mu_seq4_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq4_1_conv1_1
    #pragma HLS INTERFACE m_axi port=Mu_seq4_1_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq4_1_conv2_1
    #pragma HLS INTERFACE m_axi port=Var_seq1_0_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq1_0_conv1_1
    #pragma HLS INTERFACE m_axi port=Var_seq1_0_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq1_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Var_seq1_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq1_1_conv1_1
    #pragma HLS INTERFACE m_axi port=Var_seq1_1_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq1_1_conv2_1
    #pragma HLS INTERFACE m_axi port=Var_seq4_0_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq3_0_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq3_0_conv1_1
    #pragma HLS INTERFACE m_axi port=Var_seq3_0_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq3_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Var_seq3_0_downsample_1
    #pragma HLS INTERFACE m_axi port=Var_seq3_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq3_1_conv1_1
    #pragma HLS INTERFACE m_axi port=Var_seq3_1_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq3_1_conv2_1
    #pragma HLS INTERFACE m_axi port=Var_seq4_0_conv1_1
    #pragma HLS INTERFACE m_axi port=Var_seq4_0_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq4_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Var_seq4_0_downsample_1
    #pragma HLS INTERFACE m_axi port=Var_seq4_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq4_1_conv1_1
    #pragma HLS INTERFACE m_axi port=Var_seq4_1_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq4_1_conv2_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq1_0_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq1_0_conv1_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq1_0_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq1_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq1_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq1_1_conv1_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq1_1_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq1_1_conv2_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq3_0_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq3_0_conv1_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq3_0_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq3_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq3_0_downsample_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq3_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq3_1_conv1_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq3_1_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq3_1_conv2_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq4_0_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq4_0_conv1_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq4_0_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq4_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq4_0_downsample_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq4_1_conv1_0_1
    ...
    #pragma HLS INTERFACE m_axi port=Mu_seq2_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Mu_seq2_0_downsample_1
    #pragma HLS INTERFACE m_axi port=Mu_seq2_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq2_1_conv1_1
    #pragma HLS INTERFACE m_axi port=Mu_seq2_1_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq2_1_conv2_1
    #pragma HLS INTERFACE m_axi port=Mu_seq3_0_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq3_0_conv1_1
    #pragma HLS INTERFACE m_axi port=Mu_seq3_0_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq3_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Mu_seq3_0_downsample_1
    #pragma HLS INTERFACE m_axi port=Mu_seq3_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq3_1_conv1_1
    #pragma HLS INTERFACE m_axi port=Mu_seq3_1_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Mu_seq3_1_conv2_1
    #pragma HLS INTERFACE m_axi port=Bias_seq1_0_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Bias_seq1_0_conv1_1
    #pragma HLS INTERFACE m_axi port=Bias_seq1_0_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Bias_seq1_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Bias_seq1_1_conv1_0_1
    ...
    #pragma HLS INTERFACE m_axi port=Var_seq2_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Var_seq2_0_downsample_1
    #pragma HLS INTERFACE m_axi port=Var_seq2_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq2_1_conv1_1
    #pragma HLS INTERFACE m_axi port=Var_seq2_1_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Var_seq2_1_conv2_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq2_0_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq2_0_conv1_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq2_0_conv2_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq2_0_conv2_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq2_0_downsample_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq2_1_conv1_0_1
    #pragma HLS INTERFACE m_axi port=Gamma_seq2_1_conv1_1
