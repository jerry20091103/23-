            ...
            dtype* X_tmp_data, dtype* X_batch_data, dtype* X_mid_data)
{
    ...
    //         int_t offset = c*Y_num[2]*Y_num[3]*Y_num[4];
    //         for(int_t k = 0; k < Y_num[2]*Y_num[3]*Y_num[4]; k++){
    //             int_t tmp = (int_t)roundf(((Y_bram[offset+k]*4.303903132677078247e-02*Kernel_seq1_0_conv2_0_3_scale[yi*8+c] - Mu_seq1_0_conv2_1[yi*8+c]) / sqrtf(Var_seq1_0_conv2_1[yi*8+c]+0.00001)) * Gamma_seq1_0_conv2_1[yi*8+c] + Bias_seq1_0_conv2_1[yi*8+c]);
