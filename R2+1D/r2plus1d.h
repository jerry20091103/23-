...
void Residual(dtype* X, dtype* X_tmp, int size, double X_scale, double X_tmp_scale, double out_scale, int_t X_zeropoint, int_t X_tmp_zeropoint, int_t out_zeropoint);
