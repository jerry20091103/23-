set moduleName sw_compute_Pipeline_VITIS_LOOP_75_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sw_compute_Pipeline_VITIS_LOOP_75_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln76_1 int 62 regular  }
	{ im int 64 regular  }
	{ acc int 32 regular {array 125 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "im","offset": { "type": "dynamic","port_name": "im","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln76_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "im", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln76_1 sc_in sc_lv 62 signal 1 } 
	{ im sc_in sc_lv 64 signal 2 } 
	{ acc_address0 sc_out sc_lv 7 signal 3 } 
	{ acc_ce0 sc_out sc_logic 1 signal 3 } 
	{ acc_we0 sc_out sc_logic 1 signal 3 } 
	{ acc_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln76_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln76_1", "role": "default" }} , 
 	{ "name": "im", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "im", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln76_1 { ap_none {  { sext_ln76_1 in_data 0 62 } } }
	im { ap_none {  { im in_data 0 64 } } }
	acc { ap_memory {  { acc_address0 mem_address 1 7 }  { acc_ce0 mem_ce 1 1 }  { acc_we0 mem_we 1 1 }  { acc_d0 mem_din 1 32 } } }
}
