set moduleName sw_compute_Pipeline_VITIS_LOOP_89_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sw_compute_Pipeline_VITIS_LOOP_89_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ acc int 32 regular {array 125 { 2 2 } 1 1 }  }
}
...
set portList { 
	...
	{ acc_we1 sc_out sc_logic 1 signal 0 } 
	{ acc_d1 sc_out sc_lv 32 signal 0 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_10ns_32_2_1_U8", "Parent" : "0"},
...
set Spec2ImplPortList { 
	acc { ap_memory {  { acc_address0 mem_address 1 7 }  { acc_ce0 mem_ce 1 1 }  { acc_we0 mem_we 1 1 }  { acc_d0 mem_din 1 32 }  { acc_q0 mem_dout 0 32 }  { acc_address1 MemPortADDR2 1 7 }  { acc_ce1 MemPortCE2 1 1 }  { acc_we1 MemPortWE2 1 1 }  { acc_d1 MemPortDIN2 1 32 }  { acc_q1 in_data 0 32 } } }
}
