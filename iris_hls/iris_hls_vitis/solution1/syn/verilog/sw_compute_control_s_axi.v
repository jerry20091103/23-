...
// ==============================================================
`timescale 1ns/1ps
module sw_compute_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER          = 6'h08,
    ADDR_ISR          = 6'h0c,
    ADDR_IM_DATA_0    = 6'h10,
    ADDR_IM_DATA_1    = 6'h14,
    ADDR_IM_CTRL      = 6'h18,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_IM_DATA_0: begin
                    rdata <= int_im[31:0];
                end
                ADDR_IM_DATA_1: begin
                    rdata <= int_im[63:32];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IM_DATA_0)
            int_im[31:0] <= (WDATA[31:0] & wmask) | (int_im[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IM_DATA_1)
            int_im[63:32] <= (WDATA[31:0] & wmask) | (int_im[63:32] & ~wmask);
    end
end
