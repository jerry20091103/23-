...
HD_PWD='E:/HLS_Projects/iris_hls/iris_hls_vivado/iris_hls_vivado.runs/design_1_iris_module_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_iris_module_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_iris_module_0_1.tcl
