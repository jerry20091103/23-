...
HD_PWD='E:/HLS_Projects/iris_hls/iris_hls_vivado/iris_hls_vivado.runs/design_2_sw_compute_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_sw_compute_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_sw_compute_0_0.tcl
